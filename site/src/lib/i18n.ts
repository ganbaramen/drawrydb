...
//
// Strings carry no decoration: the back links' "←" and home.viewAll's "→"
// were dropped when those became <Button> with a Lucide chevron/arrow, so
// the label here is words only.
...
const ja: Dict = {
  ...
  'events.tickets': 'チケット',
  'events.sale': 'チケット発売',
  'events.saleGeneral': '一般',
  'events.saleRange': '{start}〜{end}',
  'events.note': '備考',
  ...
  'songs.opened': '最初の曲',
  'songs.closed': '最後の曲',
  'songs.openedShort': '最初',
  'songs.closedShort': '最後',
  'songs.columns': '列',
  'songs.playsShort': '披露',
  'songs.showsShort': '公演',
  'songs.lastPerformedShort': '最新',
  'songs.streakShort': '連続',
  'songs.longestStreakShort': '最長',
  'songs.credits': '楽曲情報',
  'songs.number': '番号',
  'songs.numberShort': '#',
  'songs.lyrics': '作詞',
  ...
  'songs.note': 'メモ',
  'songs.history': '披露一覧',
  'creators.title': 'クリエイター一覧',
  'creators.count': '{n}人',
  'creators.back': 'クリエイター一覧に戻る',
  'creators.songCount': '{n}曲を担当',
  'venues.title': '会場一覧',
  'venues.count': '{n}会場',
  'venues.back': '会場一覧に戻る',
  'venues.shows': '公演回数',
...
const en: Dict = {
  ...
  'events.sale': 'On sale',
  'events.saleGeneral': 'General',
  'events.saleRange': '{start} to {end}',
  'events.note': 'Note',
  ...
  'songs.opened': 'Opened the set',
  'songs.closed': 'Closed the set',
  'songs.openedShort': 'Opened',
  'songs.closedShort': 'Closed',
  'songs.columns': 'Columns',
  'songs.playsShort': 'Plays',
  'songs.showsShort': 'Shows',
  'songs.lastPerformedShort': 'Last',
  'songs.streakShort': 'Streak',
  'songs.longestStreakShort': 'Longest',
  ...
  'creators.back': 'Back to creators',
  'creators.songCount': 'Credited on {n} songs',
  'venues.title': 'Venues',
